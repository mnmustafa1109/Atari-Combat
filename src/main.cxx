...
int main() {
    ...
    Shader shaderProgram1 = Shader("../shaders/shader1.vs", "../shaders/shader1.fs");
    Shader shaderProgram2 = Shader("../shaders/shader2.vs", "../shaders/shader2.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        shaderProgram2.use();
        shaderProgram2.setv4f("ourColor", 1.0f, 0.0f, 0.0f, 1.0f);
        glBindVertexArray(VAOs[2]);
